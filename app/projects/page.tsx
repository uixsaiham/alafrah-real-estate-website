...
const headings: Record<ListingType, { kicker: string; title: React.ReactNode; image: string }> = {
  Buy: {
  ...
  Sell: {
    ...
    title: (
      <>
        Verified units,<br /><em className="italic text-gold">independently owned.</em>
      </>
    ),
      ...
      <div className="relative bg-moss-dark overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <Container className="pt-[125px] pb-[64px] md:pt-[164px] md:pb-[80px]">
            <Reveal>
              <Kicker className="text-[#f3e6c2]">{heading.kicker}</Kicker>
