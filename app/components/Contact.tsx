...
const inquiryTypes = ["Booking", "Leasing", "Payment", "Discussion", "Site visit"];
      ...
      <Container className="grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[80px]">
        <Reveal>
          ...
          <h2 className="font-serif font-bold text-[44px] md:text-[52px] leading-[1.02] tracking-[-.04em] mb-8">
            Let&apos;s shape<br /><em className="italic text-gold-dark">your next address.</em>
          </h2>
          <div className="grid gap-6">
            ...
            <a href="mailto:info@alafrah.com.bd" className="flex items-center gap-4">
              <span className="grid place-items-center w-11 h-11 rounded-full bg-paper text-moss shrink-0">
                <Mail size={17} strokeWidth={1.6} />
              </span>
              <div>
                <div className="text-[15px] font-medium">info@alafrah.com.bd</div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-muted text-[12px]">Gulshan Avenue, Dhaka, Bangladesh</div>
              </div>
            </div>
          </div>
        </Reveal>
          ...
          >
            ...
            {submitted ? (
              ...
              <div className="grid gap-5">
                ...
                <button
                  type="submit"
                  className="group flex items-center justify-between w-full px-[18px] py-4 mt-2 border-0 bg-moss text-white text-[13px] transition-all duration-200 hover:-translate-y-0.5 hover:bg-moss-dark hover:shadow-[0_14px_28px_rgba(20,18,26,.25)]"
                >
                  Send enquiry{" "}
